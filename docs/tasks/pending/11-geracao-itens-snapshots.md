# Tarefa 11 — Geração de itens e snapshots
...
Gerar os itens da supervisão preservando o estado metodológico.
...
- itens da supervisão;
- snapshot do critério;
- snapshot dos aspectos;
- snapshot do modelo e opções;
- idempotência;
- testes;
