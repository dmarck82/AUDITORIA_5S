# Tarefa 07 — Associação atividade-critério (superada)

## Status

SUPERADA pela reformulação simplificada aprovada em 2026-08-01.

## Motivo da superação

A reformulação remove Atividades e altera o papel dos critérios; esta tarefa não deve ser executada.

## Objetivo

Permitir vincular critérios universais às atividades.
