# Tarefa 08 — Aspectos de verificação
...
Implementar aspectos específicos para cada associação atividade-critério.
...
- CRUD de aspectos;
- descrição, ordem, obrigatório e status;
- vínculo com atividade_criterio;
- ordenação;
- permissões e testes;

## Fora do escopo ou dependências

- resposta por aspecto;
- supervisões;
