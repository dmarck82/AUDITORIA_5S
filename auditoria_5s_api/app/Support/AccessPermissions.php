...
class AccessPermissions
{
    ...
    private const PERMISSIONS = [
        ...
        'evaluation_dimensions.view',
        'evaluation_dimensions.create',
        'evaluation_dimensions.update',
        'evaluation_dimensions.delete',
        'evaluation_models.view',
        'evaluation_models.create',
        'evaluation_models.update',
        'evaluation_models.delete',
        'evaluation_model_options.view',
        'evaluation_model_options.create',
        'evaluation_model_options.update',
        'evaluation_model_options.delete',
        'people.view',
        'people.create',
        'people.update',
        'people.delete',
